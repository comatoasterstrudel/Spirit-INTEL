...
class Constants 
{
	...
	public static final skillOutlineGraphicPath:String = "assets/images/skills/box/box_outline.png";
	...
	public static final vsSpiritUnlocked:String = "assets/images/victoryscreen/vs_spiritunlocked.png";
	// TurnAttentionAnim
